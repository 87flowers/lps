  ...
  namespace detail {
    ...
    struct vector_helper {
      using type = std::conditional_t<
        ...
        std::conditional_t<(sizeof(T) * N == 16 * sizeof(u8)), sse4_2::vector<T, N, environment>, doubling::vector<T, N, environment>>>;
    };
    ...
    struct vector_mask_helper {
      using type = std::conditional_t<
        (sizeof(T) * N < 16 * sizeof(u8)), void,
        std::conditional_t<(sizeof(T) * N == 16 * sizeof(u8)), sse4_2::vector_mask<T, N, environment>, doubling::vector_mask<T, N, environment>>>;
    };
